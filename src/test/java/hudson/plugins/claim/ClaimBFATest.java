...
public class ClaimBFATest {
    ...
    public void canReclaimFailureCause() throws Exception{
        applyClaimWithFailureCauseSelected("claim", CAUSE_NAME_2, REASON);
    ...
    private ClaimBuildAction applyClaimWithFailureCauseSelected(String element, String error, String reason) throws Exception {
        HtmlPage page = whenNavigatingtoClaimPage();
